...
class baseMainWindow(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.botton_main = wx.Button(self, wx.ID_ANY, u"清空", wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer1.Add(self.botton_main, 0, wx.ALL, 5)
        ...
        # Connect Events
        self.botton_main.Bind(wx.EVT_BUTTON, self.main_button_click)
